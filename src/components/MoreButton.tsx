  ...
  return (
    <Grid item xs={12} mt={4} mb={4}>
      <Divider sx={{
        ...
        <Chip disabled={disabled} onClick={fetchMore} size="medium" sx={{ color: theme.palette.mode === 'light' ? '#fff' : 'black', backgroundColor: theme.palette.mode === 'light' ? "#272B2F" : "white", borderColor: theme.palette.mode === 'light' ? 'rgba(194, 224, 255, 0.08)' : 'white' }} label={
          <Stack direction={'row'}>
